...
SOURCES = [
    # ── 모델 업데이트 ────────────────────────────────────────────────────────
    dict(id="openai", name="OpenAI", section="model_updates", kind="rss",
         url="https://openai.com/news/rss.xml"),
    dict(id="google_blog", name="Google", section="model_updates", kind="rss",
         url="https://blog.google/rss/"),
    dict(id="mistral", name="Mistral", section="model_updates", kind="rss",
         # 공식 문서에 없지만 실제로 동작한다 (티켓 01에서 확인)
         url="https://mistral.ai/news/rss"),
    dict(id="anthropic_mirror", name="Anthropic", section="model_updates", kind="rss",
    ...
    dict(id="hf_deepseek", name="Hugging Face", section="model_updates", kind="hf",
         url="https://huggingface.co/api/models?author=deepseek-ai&sort=createdAt&direction=-1&limit=8"),
    dict(id="hf_qwen", name="Hugging Face", section="model_updates", kind="hf",
         url="https://huggingface.co/api/models?author=Qwen&sort=createdAt&direction=-1&limit=8"),
    dict(id="hf_meta", name="Hugging Face", section="model_updates", kind="hf",
         url="https://huggingface.co/api/models?author=meta-llama&sort=createdAt&direction=-1&limit=8"),

    # ── 뉴스 ────────────────────────────────────────────────────────────────
    dict(id="techcrunch_ai", name="TechCrunch", section="top_headlines", kind="rss",
         url="https://techcrunch.com/category/artificial-intelligence/feed/"),
    dict(id="verge_ai", name="The Verge", section="top_headlines", kind="atom",
         url="https://www.theverge.com/rss/ai-artificial-intelligence/index.xml"),
    dict(id="ars_ai", name="Ars Technica", section="top_headlines", kind="rss",
         url="https://arstechnica.com/ai/feed/"),
    dict(id="techmeme", name="Techmeme", section="top_headlines", kind="rss",
         url="https://www.techmeme.com/feed.xml"),
    dict(id="hn", name="Hacker News", section="top_headlines", kind="hn",
         url="https://hn.algolia.com/api/v1/search?tags=story&hitsPerPage=60&query=AI"),
    dict(id="geeknews", name="GeekNews", section="top_headlines", kind="atom",
         url="https://news.hada.io/rss/news"),
    dict(id="etnews_ai", name="전자신문", section="top_headlines", kind="rss", tz=9,
    ...
    dict(id="aitimes", name="AI타임스", section="top_headlines", kind="rss", tz=9,
